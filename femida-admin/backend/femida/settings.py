...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'femida'),
        'USER': os.environ.get('POSTGRES_USER', 'femida'),
        'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'femida'),
...
CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://femida.kg, http://localhost:3000,http://127.0.0.1:3000').split(',')
